...
<div class="bogoCoupon"> <img src="images/jpg/bogoCoupon-lx2.jpg" width="305" height="325" alt="Buy a $2 Florida LOTTO with XTRA ticket and Get a FREE $2 FLORIDA LOTTO with XTRA Quick Pick ticket"/>
  <p class="couponTitle" style="margin: 15px 10px 16px 10px;">Buy a  $2 FLORIDA LOTTO<sup>&#174;</sup> with XTRA ticket, get a FREE $2<br />FLORIDA LOTTO<sup>&#174;</sup> with XTRA Quick Pick ticket</p>
     <p>Take this coupon to any Florida Lottery retailer by May 31, 2017, and <strong>get a FREE FLORIDA LOTTO<sup>&#174;</sup> with XTRA Quick Pick ticket</strong> when you purchase a $2 FLORIDA LOTTO<sup>&#174;</sup> with XTRA ticket. Not valid towards the purchase of any other Florida Lottery games. Coupon can only be used one time. Must be 18 or older to play. Play responsibly.</p>
     <p>Retailers: Clear TOTAL from your screen. Scan coupon via barcode scanner (do not insert in reader channel). Complete the FLORIDA LOTTO<sup>&#174;</sup> with XTRA sale on the manual screen and the FREE FLORIDA LOTTO<sup>&#174;</sup> with XTRA Quick Pick ticket for the next available draw will automatically print. Collect the money for the ticket sale.  Give both the purchased ticket and the FREE ticket to the player.  If barcode does not scan, it can be entered manually. Select Settings and Redeem Coupon to enter barcode numbers manually. Omit the first digit "1" of the barcode number, and enter the number manually.  The FLORIDA LOTTO<sup>&reg;</sup> with XTRA ticket cannot be cancelled.</p>
     ${request.barcode1}
