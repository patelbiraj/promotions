...
<tiles:insertTemplate template="structure/baseTemplate.jsp">
	<tiles:putAttribute name="additionalHeader" type="string" value="<link href='style/signUp.css' type='text/css' rel='stylesheet'>" />
	...
	<tiles:putAttribute name="body" type="template" value="../removeAccount_email.jsp" />
