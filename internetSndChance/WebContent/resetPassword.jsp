...
<div id="main">
	<div id="mainContent">
		...
		<p style="font-weight: bold; ">You have been automatically logged out of your account due to a password authentication upgrade. Please follow the steps below to change your password.</p>
		<p>Please enter your registered email address and click "Submit" to get Verification Code via email.</p>
					
		<s:form action="submitEmailForReset" method="post" cssClass="forgotPassword">
