...
<tiles:insertTemplate template="structure/baseTemplate.jsp">
	...
	<tiles:putAttribute name="title" type="string" value="Frequently Asked Questions - Florida Lottery Bonus Play Drawings &amp; Promotions" />
	...
	<tiles:putAttribute name="body" type="template" value="../faqs.jsp" />
