...
<tiles:insertTemplate template="structure/baseTemplate.jsp">
	...
	<tiles:putAttribute name="title" type="string" value="Printable Coupon - Florida Lottery Bonus Play Drawings &amp; Promotions" />
	...
	<tiles:putAttribute name="body" type="template" value="../submitPrintCoupon.jsp" />
