...
<tiles:insertTemplate template="structure/baseTemplate.jsp">
	<tiles:putAttribute name="additionalHeader" type="string" value="<link rel='stylesheet' type='text/css' media='screen' href='style/ticketEntryHistory.css' >" />
	...
	<tiles:putAttribute name="body" type="template" value="../ticketEntryHistoryEntries.jsp" />
