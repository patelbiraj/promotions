	...
	<div id="mainContentWrap">
	  <div id="mainContent">
		<h1><s:property value="messages.h1Title" /></h1>
		  <p>If you're a winner in the  Cash Payday Second Chance Promotion, congratulations!</p>
          <p>The Florida Lottery's Claims Processing Office will attempt to notify the prize winners following each drawing. If you have not yet been contacted and would like to claim your prize, please call (850) 487-7707.</p>
			...
			<ol>
				<li>The original valid non-winning, <strong>WEEK FOR LIFE</strong> Scratch-Off ticket bearing the entry number selected in the drawing. Without such ticket, the winner will forfeit his or her right to claim a prize.  </li>
		...
		<p><strong>Acceptable forms of identification include: </strong></p>		         		
            ...
            <p>The required documentation may either be delivered to one of the <a href="http://www.flalottery.com/lotteryOffices">Lottery Offices</a> or mailed to:</p>
               <blockquote>
					Florida Lottery<br/>
					   Claims Processing: Cash Payday Second Chance Promotion <br/>
			...
			<p>For additional information about claiming prizes and alternate winners, please read the Official <a href="rules_2019-cashPayday">Cash Payday Second Chance Promotion Rule </a>.</p>
		</div>
	</div>
</div>