...
<div id="main">
	<div id="topBanner">
     ...
     <div id="mainContentWrap">
          <div id="mainContent">
               ...
               <h1>TICKET  ENTRY</h1>
			  <p>To enter your non-winning <strong>$5,000,000 LUCK</strong> or any <strong>HOLIDAY LUCK</strong> Scratch-Off ticket in the Second Chance promotion:</p>
               <div id="sampleTicket" >
                    <img  src="promotions/2019/images/jpg/holidayLuck_UpdatedTicketSample.jpg" alt="Holiday Luck" width="338" height="416" align="left" />
               </div>
               <ol>
    ...
    <s:if test="%{promotion.promotionInterval.containsNow()}">
		<s:form id="ticketEntryForm" action="entry_2019-holidayLuck">	
    ...
    <!--Beginning of Promotion Ending Message-->    
     ...
     <!--End of Promotion Ending Message-->               
				...
				<strong><br>Remember: DO NOT throw away the tickets that you submit online. Winners must have to claim their prizes.</strong></p>
			   ...
			   <hr/>
			     ...
			     <h2 class="tktEntry">My $5,000,000 LUCK and HOLIDAY LUCK Scratch-Off Ticket Entry List<!--<span><s:property escapeHtml="false" value="%{promotion.name}" /></span> <s:property value="messages.h1Title" />--> </h2>
