	...
	<div id="mainContentWrap">
	  <div id="mainContent">
		<h1><s:property value="messages.h1Title" /></h1>
		  <p>If you're a winner in the Lotto Cash Second Chance Promotion, congratulations!</p>
          <p>The Florida Lottery's Claims Processing Office will attempt to notify the prize winners following each drawing. If you have not yet been contacted and would like to claim your prize, please call (850) 487-7707.</p>
			...
			<p><strong>Grand and Second Prize Winners: </strong></p>	
			<ol>
				...
				<li>Copy of acceptable identification that is current or was issued within the past five years <u>and  bears</u> a serial number or other identifying number. </li>
			</ol> 
		...
		<p><strong>Acceptable forms of identification include: </strong></p>		         		
            ...
            <p>The required documentation may either be delivered to one of the <a href="http://www.flalottery.com/lotteryOffices">Lottery Offices</a> or mailed to:</p>
               <blockquote>
					Florida Lottery<br/>
					   Claims Processing: Lotto Cash Second Chance Promotion <br/>
			...
			<p>For additional information about claiming prizes and alternate winners, please read the Official <a href="rules_2019-lottoCash">Lotto Cash Second Chance Promotion Rule </a>.</p>
		</div>
	</div>
</div>