...
<div id="main" class="monopoly entry">
	<div id="topBanner">
     ...
     <div id="mainContentWrap">
          <div id="mainContent">
               ...
               <p>To enter your non-winning <strong>GOLD RUSH DOUBLER</strong> Scratch-Off ticket in the second chance promotion:</p>
               <div id="sampleTicket">
                    <img src="promotions/2017/images/jpg/goldRushDoubler-ticketSample.jpg" alt="Gold Rush Doubler Ticket Sample" width="385" height="456" />
               </div>
               <ol>
  ...
  <s:form id="ticketEntryForm" action="entry_2017-goldRushDoubler">	
    ...
    <!--Beginning of Promotion Ending Message-->    
     ...
     <!--End of Promotion Ending Message-->               
               ...
               <hr />
               <h2 class="tktEntry">My <span><s:property escapeHtml="false" value="%{promotion.name}" /></span> <s:property value="messages.h1Title" /> List</h2>
