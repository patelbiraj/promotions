	...
	<div id="mainContentWrap">
	  <div id="mainContent">
		<h1><s:property value="messages.h1Title" /></h1>
		  <p>If you're a winner in the  <b>Florida Jackpots Bonus Play Promotion</b>, congratulations!</p>
		...
		<p><strong>Acceptable forms of identification include: </strong></p>		         		
            ...
            <p>The required documentation may either be delivered to one of the <a href="http://www.flalottery.com/lotteryOffices">Lottery Offices</a> or mailed to:</p>
               <blockquote>
					Florida Lottery<br/>
						<strong>Florida Jackpots Bonus Play Promotion</strong><br/>
			...
			<p>U.S. Postal Service regulations include various restrictions on mailing Lottery tickets. The risk of mailing tickets remains with the player and will not be assumed by the Florida Lottery.</p>
		  	...
		  	<p><span class = "u">The required documentation must be received by the Florida Lottery no later than fourteen calendar days after being notified by the Florida Lottery that you are a winner.</span></p>
			...
			<p>For additional information about claiming prizes and alternate winners, please read the Official <a href="rules_2021-floridaJackpots">Florida Jackpots Bonus Play Promotion Rule</a>.</p>
