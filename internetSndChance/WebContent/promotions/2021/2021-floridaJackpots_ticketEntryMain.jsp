...
<tiles:insertTemplate template="../../structure/baseTemplate.jsp">
	...
	href='promotions/2021/style/2021-floridaJackpots_styles.css' />" />
	...
	<tiles:putAttribute name="body" type="template" value="../promotions/2021/2021-floridaJackpots_ticketEntry.jsp" />
