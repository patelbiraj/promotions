...
<tiles:insertTemplate template="../../structure/baseTemplate.jsp">
	<tiles:putAttribute name="additionalHeader" type="string" value="<link rel='stylesheet' type='text/css' href='promotions/2021/style/2021-guyharvey_styles.css' />" />
	...
	<tiles:putAttribute name="body" type="template" value="../promotions/2021/2021-guyharvey_howtoclaim.jsp" />
