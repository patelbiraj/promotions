...
<s:if
	...
	<s:set var="content"
		value="%{'promotions/2021/2021-guyharvey-3_winrpt.html'}" />
</s:if>

<script type="text/javascript" src="js/secondChance.js"></script>
<script type="text/javascript">
	var page = 5;
	var baseurl = 'winners_2021-guyharvey?winrpt=';
	function visit1(){
		var query = "promotions/2021/2021-guyharvey-1_winrpt.html";
		var url = baseurl + encodeURIComponent(query);
		location.href =  url;
	}
	function visit2(){
		var query = "promotions/2021/2021-guyharvey-2_winrpt.html";
		var url = baseurl + encodeURIComponent(query);
		location.href =  url;
	}
	function visit3(){
		var query = "promotions/2021/2021-guyharvey-3_winrpt.html";
		var url = baseurl + encodeURIComponent(query);
		location.href =  url;
	}
</script>

<div id="main" class="guyharvey">
	<div id="topBanner">
		...
		<div id="subNav">
			<div id="subNavContent">
				...
				<ul>
					...
					<li>
						<a onClick="visit1()" class="toIframe" href="#">June 21, 2021</a> 
						<a href="promotions/2021/2021-guyharvey-1_winrpt.html">
							<img src="images/png/printer.png" alt="Print Winners" width="34"
							height="19" border="0" title="Print Winners" />
						</a>
					</li>
					<li>
						<a onClick="visit2()" class="toIframe" href="#">July 19, 2021</a> 
						<a href="promotions/2021/2021-guyharvey-2_winrpt.html">
							<img src="images/png/printer.png" alt="Print Winners" width="34"
								height="19" border="0" title="Print Winners" />
						</a>
					</li>
					...
					<li>
						<a onClick="visit3()" class="toIframe" href="#">August 9, 2021</a> 
						<a href="promotions/2021/2021-guyharvey-3_winrpt.html">
							<img src="images/png/printer.png" alt="Print Winners" width="34"
								height="19" border="0" title="Print Winners" />
						</a>
					</li>
