...
<joda:parseDateTime var="Winners" value="12/12/2024 08:00:00" pattern="M/d/y H:m:s" />
<s:set var="content" value="%{(#parameters.winrpt)[0]}" />
<s:if
	test="%{@org.apache.commons.lang3.StringUtils@isBlank(#attr.content)}">
	<s:set var="content"
		value="%{'promotions/2024/2024-holidayBlowout_winrpt-2.html'}" />
</s:if>
<script type="text/javascript" src="js/secondChance.js"></script>
<script type="text/javascript">
	var page = 5;
	var baseurl = 'winners_2024-holidayBlowout?winrpt=';
	function visit1(){
		var query = "promotions/2024/2024-holidayBlowout_winrpt-1.html";
		var url = baseurl + encodeURIComponent(query);
		location.href =  url;
	}
	
	function visit2(){
		var query = "promotions/2024/2024-holidayBlowout_winrpt-2.html";
		var url = baseurl + encodeURIComponent(query);
		location.href =  url;
	}
...
<div id="main">
		...
		<div id="subNav">
			<div id="subNavContent">
				<h3 style="text-align: left;">Select a Drawing</h3>
				 <ul>
					<li>
						<a onClick="visit1()" class="toIframe" href="#">December 10, 2024</a> 
						<a href="promotions/2024/2024-holidayBlowout_winrpt-1.html">
					...
					<li>
						<a onClick="visit2()" class="toIframe" href="#">January 14, 2025</a> 
						<a href="promotions/2024/2024-holidayBlowout_winrpt-2.html">
							<img src="images/png/printer.png" alt="Print Winners" width="34"
							height="19" border="0" title="Print Winners" />
						</a>
					</li>
	...
	<s:else>
		<p style="font-weight: bold; text-align: center;">Winners list will be posted starting December 12, 2024 8:00 AM EST</p>
	</s:else>
	<p>
