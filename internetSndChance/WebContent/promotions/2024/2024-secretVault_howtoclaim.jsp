...
<div id="main" class="bonusPlayGetaway howtoplay">
	...
	<div id="mainContentWrap">
		<div id="mainContent">
			...
			<p>If you're a winner in the Cash Vault Bonus Play Promotion, congratulations!</p>
			...
			<p>Florida Lottery<br>
				<strong>Cash Vault Bonus Play Promotion</strong><br>
			...
			<p>The required documentation must be <u>received by the Florida Lottery no later than</u> <strong><u>ten calendar</u></strong> days after being notified by the Florida Lottery that you are a winner.</p>
			...
			<p>For additional information about claiming prizes and alternate winners, please read the Official <a href="rules_2024-secretVault">Cash Vault Bonus Play Promotion</a>.</p>
		</div>
	</div>
</div>