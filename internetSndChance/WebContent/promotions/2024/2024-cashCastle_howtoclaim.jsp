...
<div id="main" class="bonusPlayGetaway howtoplay">
	...
	<div id="mainContentWrap">
		<div id="mainContent">
			...
			<p>If you're a winner in the Cash Castle Bonus Play Promotion, congratulations!</p>
			...
			<p><strong>NOTE:</strong> The Florida Lottery deems the prizewinner's registration data as the prizewinner's official contact information, including the physical mailing address. 
			The Florida Lottery will not attempt to further locate a prizewinner if attempts to reach the prizewinner by telephone or email are unsuccessful.</p>
			
			<p>To claim a prize won in a Promotion, the prizewinner must submit to the Florida Lottery the following documentation:</p>
			
			<ol>
				<li>Completed and signed Winner Claim Form: <a href="http://www.flalottery.com/exptkt/claimForm_en.pdf">English</a>
				<a href="http://www.flalottery.com/exptkt/spanishWinnerClaim.pdf">Spanish</a></li>
				<li>Completed DOL 474 TRIP Ireland Winner, Acknowledgement, and Authorization form.</li>
			...
			<p>Florida Lottery<br>
				<strong>Cash Castle Bonus Play Promotion</strong><br>
			...
			<p>The required documentation must be received by the Florida Lottery no later than <strong><u>ten calendar</u></strong> days after being notified by the Florida Lottery that you are a winner.</p>
			...
			<p>For additional information about claiming prizes and alternate winners, please read the Official <a href="rules_2024-cashCastle">Cash Castle Bonus Play Promotion</a></p>
		</div>
	</div>
</div>