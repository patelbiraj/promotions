...
<tiles:insertTemplate template="../../structure/baseTemplate.jsp">
	...
	href='promotions/2024/style/2024-holidayBlowout_styles.css' />" />
	...
	<tiles:putAttribute name="body" type="template" value="../promotions/2024/2024-holidayBlowout_ticketEntry.jsp" />
