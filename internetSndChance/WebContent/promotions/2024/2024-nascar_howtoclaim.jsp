...
<div id="main" class="bonusPlayGetaway howtoplay">
	...
	<div id="mainContentWrap">
		<div id="mainContent">
			...
			<p>The Florida Lottery's Claims Processing Office will attempt to notify the prize winners not later than one business day after the prizewinners are posted on the Florida Lottery's website. If you have not yet been contacted and would like to claim your prize, please call (850) 487-7707.</p>
			...
			<p>The required documentation may either be delivered to one of the <a href="https://floridalottery.com/about/lottery-offices">Lottery Offices</a> or mailed to:</p>
			...
			<p>For additional information about claiming prizes and alternate winners, please read the Official <a href="rules_2024-nascar">NASCAR POWERALL Playoff Bonus Play Promotion</a>.</p>
		</div>
	</div>
</div>