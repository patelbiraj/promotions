	...
	<div id="mainContentWrap">
	  <div id="mainContent">
		<h1><s:property value="messages.h1Title" /></h1>
		  <p>If you're a winner in the  Xtra Chance Promotion, congratulations!</p>
          <p>The Florida Lottery's Claims Processing Office will attempt to notify the prize winners no later than one business day after the prizewinners are posted on the Florida Lottery's website. If you have not yet been contacted and would like to claim your prize, please call (850) 487-7707.</p>
			...
			<ol>
				<li>The original valid non-winning, <strong>X Mutliplier family</strong> Scratch-Off ticket bearing the entry number selected in the drawing. Without such ticket, the winner will forfeit his or her right to claim a prize.  </li>
		...
		<p><strong>Acceptable forms of identification include: </strong></p>		         		
			...
			<p>U.S. Postal Service regulations include various restrictions on mailing Lottery tickets. The risk of mailing tickets remains with the player and will not be assumed by the Lottery.</p>
		  	...
		  	<p><span class = "u">The required documentation must be received by the Florida Lottery no later than <strong>seven</strong> calendar days after being notified by the Florida Lottery that you are a winner.</span></p>
			...
			<p>For additional information about claiming prizes and alternate winners, please read the Official <a href="rules_2020-xMultiplier">Xtra Chance Promotion Rule </a>.</p>
		</div>
	</div>
</div>