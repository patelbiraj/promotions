	...
	<div id="topBanner">
     ...
     <div id="mainContentWrap">
          <div id="mainContent">
               ...
               <h1>TICKET  ENTRY</h1>
			  <p>To enter your non-winning <strong>X MULTIPLIER</strong> Scratch-Off ticket in the Xtra Chance Promotion:</p>
               <div id="sampleTicket" >
                    <img  src="promotions/2020/images/jpg/xMultiplier_TicketSample.gif" alt="XMultiplier" width="383" height="441" align="left" />
               </div>
               <ol>
                    <li>Scratch off the coating covering at the bottom of your non-winning ticket to reveal the 24-digit ticket number. (See Ticket Sample)</li>
                    ...
                    <li>Click <strong>SUBMIT button.</strong></li>

               </ol>
    <!--Beginning of Promotion Entry Form-->        
    <s:if test="%{promotion.promotionInterval.containsNow()}">                       
		<s:form id="ticketEntryForm" action="entry_2020-xMultiplier">	
    ...
    <!--Beginning of Promotion Ending Message-->    
     ...
     <!--End of Promotion Ending Message-->  
			   ...
			   <hr/>
			     ...
			     <h2 class="tktEntry">My X MULTIPLIER Scratch-Off Ticket Entry List<!--<span><s:property escapeHtml="false" value="%{promotion.name}" /></span> <s:property value="messages.h1Title" />--> </h2>
