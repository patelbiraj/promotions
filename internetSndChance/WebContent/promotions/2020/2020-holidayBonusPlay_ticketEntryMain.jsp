...
<tiles:insertTemplate template="../../structure/baseTemplate.jsp">
	...
	href='promotions/2020/style/2020-holidayBonusPlay_styles.css' />" />
	...
	<tiles:putAttribute name="body" type="template" value="../promotions/2020/2020-holidayBonusPlay_ticketEntry.jsp" />
