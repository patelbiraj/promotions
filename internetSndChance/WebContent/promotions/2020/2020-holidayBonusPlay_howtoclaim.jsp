	...
	<div id="mainContentWrap">
	  <div id="mainContent">
		<h1><s:property value="messages.h1Title" /></h1>
		  <p>If you're a winner in the  <b>Holiday Bonus Play Promotion</b>, congratulations!</p>
		...
		<p><strong>Acceptable forms of identification include: </strong></p>		         		
			...
			<p>For additional information about claiming prizes and alternate winners, please read the Official <a href="rules_2020-holidayBonusPlay">HOLIDAY BONUS PLAY Promotion Rule </a>.</p>
