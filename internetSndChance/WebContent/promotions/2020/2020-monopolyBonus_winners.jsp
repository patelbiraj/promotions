...
<s:if
	...
	<s:set var="content"
		value="%{'promotions/2020/2020-monopolyBonus-1_winrpt.html'}" />
</s:if>
...
<script type="text/javascript">
	var page = 5;
	var page = 5;
	var baseurl = 'winners_2020-monopolyBonus?winrpt=';
	function visit1(){
		var query = "promotions/2020/2020-monopolyBonus-1_winrpt.html";
		var url = baseurl + encodeURIComponent(query);
		location.href =  url;
	}
	function visit2(){
		var query = "promotions/2020/2020-monopolyBonus-2_winrpt.html";
		var url = baseurl + encodeURIComponent(query);
		location.href =  url;
	}
	function visit3(){
		var query = "promotions/2020/2020-monopolyBonus-3_winrpt.html";
		var url = baseurl + encodeURIComponent(query);
		location.href =  url;
	}
</script>
		...
		<div id="subNav">
			<div id="subNavContent">
				...
				<ul>
					...
					<li>
						<a onClick="visit1()" class="toIframe" href="#">July 29, 2020</a> 
						
						<a href="promotions/2020/2020-monopolyBonus-1_winrpt.html">
							<img src="images/png/printer.png" alt="Print Winners" width="34"
							height="19" border="0" title="Print Winners" />
						</a>
					</li>
					<li> 
						<a onClick="visit2()" class="toIframe" href="#">August 19, 2020
						</a> 
						<a href="promotions/2020/2020-monopolyBonus-2_winrpt.html">
							<img src="images/png/printer.png" alt="Print Winners" width="34"
							height="19" border="0" title="Print Winners" />
						</a>
					</li>
					<li>
						<a onClick="visit3()" class="toIframe" href="#">September 16, 2020</a>
            			<a href="promotions/2020/2020-monopolyBonus-3_winrpt.html"> 
            				<img src="images/png/printer.png" alt="Print Winners" width="34"
						height="19" border="0" title="Print Winners" />
						</a>
					</li>
