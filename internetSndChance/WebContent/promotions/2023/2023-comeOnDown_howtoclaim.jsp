	...
	<div id="mainContentWrap">
	  <div id="mainContent">
		<h1><s:property value="messages.h1Title" /></h1>
		  <p>If you're a winner in the COME ON DOWN Challenge Bonus Play Promotion, congratulations!</p>
		  
		  <p>The Florida Lottery's Claims Processing Office will attempt to notify the prize winners not later than one 
		  business day after the prizewinners are posted on the Florida Lottery's website. If you have not yet been contacted
		  and would like to claim your prize, please call (850) 487-7707.</p>
		  
		  <p><strong>NOTE: </strong>The Florida Lottery deems the prizewinner's registration data as the prizewinner's
		  official contact information, including the physical mailing address. The Florida Lottery will not attempt to further
		  locate a prizewinner if attempts to reach the prizewinner by telephone or email are unsuccessful.</p>
		  ...
		  <ol>
		  	<li>Completed and signed Winner Claim Form: <a href="https://www.floridalottery.com/exptkt/claimForm_en.pdf">English</a>
		  	 <a href="http://www.floridalottery.com/exptkt/claimForm_sp.pdf">Spanish</a></li>
		  ...
		  <strong>Come On Down Challenge Bonus Play Promotion</strong><br>
		  ...
		  <p>The required documentation must be received by the Florida Lottery no later than 
		  <span style="text-decoration:underline; font-weight: bold;">ten calendar</span> days after
		   being notified by the Florida Lottery that you are a winner.</p>
		  ...
		  <p>For additional information about claiming prizes and alternate winners, please read the <a href="rules_2023-comeOnDown">Official Come On Down
		  Bonus Play Promotion</a></p> 
		</div>
	</div>
</div>