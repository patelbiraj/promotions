...
<joda:parseDateTime var="Winners" value="03/28/2023 08:00:00" pattern="M/d/y H:m:s" />

<s:set var="content" value="%{(#parameters.winrpt)[0]}" />
<s:if
	test="%{@org.apache.commons.lang3.StringUtils@isBlank(#attr.content)}">
	<s:set var="content"
		value="%{'promotions/2023/2023-comeOnDown-1_winrpt.html'}" />
</s:if>

<script type="text/javascript" src="js/secondChance.js"></script>
<script type="text/javascript">
	var page = 5;
	var baseurl = 'winners_2023-comeOnDown?winrpt=';
	function visit1(){
		var query = "promotions/2023/2023-comeOnDown-1_winrpt.html";
		...
		<div id="subNav">
			<div id="subNavContent">
				...
				<ul>
					...
					<li>
						<a onClick="visit1()" class="toIframe" href="#">March 28, 2023</a> 
						<a href="promotions/2023/2023-comeOnDown-1_winrpt.html">
