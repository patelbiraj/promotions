...
<tiles:insertTemplate template="../../structure/baseTemplate.jsp">
	...
	href='promotions/2023/style/2023-fuelForLife_styles.css' />" />
	...
	<tiles:putAttribute name="body" type="template" value="../promotions/2023/2023-fuelForLife_ticketEntry.jsp" />
