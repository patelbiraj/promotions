...
<div id="main" class="monopoly howtoclaim">
	...
	<div id="mainContentWrap">
	  <div id="mainContent">
		  ...
		  <p>If you're a winner in the 30<sup>th</sup> Birthday Cash Spectacular  Second Chance Promotion, congratulations!</p>
        ...
        <p>To claim any prize, the winner must submit to the Florida Lottery the following documentation:</p>
               <ol>
				   <li>The original valid non-winning FLORIDA 5X THE CASH, FLORIDA 10X THE CASH, FLORIDA 20X THE CASH, FLORIDA 50X THE CASH, or FLORIDA 100X THE CASH Scratch-Off ticket bearing the entry number selected in the drawing. Without such ticket, the winner will forfeit his or her right to claim a prize.  </li>
                    
                    <li>Completed and signed <a href="http://www.flalottery.com/exptkt/claimForm_en.pdf" target="_blank">Winner Claim Form</a>.</li>
				   <li>Copy of acceptable identification that is current or was issued within the past five years and bears a serial number or other identifying number. </br> Acceptable forms of identification include:</li>
               ...
               <blockquote>
                Florida Lottery<br/>
				   Claims Processing &ndash;30<sup>th</sup> Birthday Cash Spectacular Second Chance Promotion<br/>
		...
		<p>For additional information about claiming prizes and alternate winners, please read the Official <a href="rules_2018-cashSpectacular"> 30<sup>th</sup> Birthday Cash Spectacular Second Chance Promotion Rule </a>.</p>
		</div>
	</div>
</div>