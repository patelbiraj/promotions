	...
	<div id="mainContentWrap">
	  <div id="mainContent">
		<h1><s:property value="messages.h1Title" /></h1>
		  <p>If you're a winner in the CASH4LIFE<sup>&reg;</sup> Bonus Bucks Promotion, congratulations!</p>
		  ...
		  <p>To claim a prize, the winner must submit to the Florida Lottery the following documentation:</p>
		  <p style="font-weight: bold" >First Prize:</p>
			<ol>
				<li>The original valid voucher bearing the unique number selected in the drawing. Without such voucher, the winner will forfeit his or her right to claim a prize.</li>
		  ...
		  <p style="font-weight: bold" >Second Prize:</p>
			<ol>
				<li>The original valid voucher bearing the unique number selected in the drawing. Without such voucher, the winner will forfeit his or her right to claim a prize.</li>
				<li>Copy of acceptable identification that is current or was issued within the past five years and bears a serial number or other identifying number.</li>
            </ol> 	
		  <p style="font-weight: bold" > Acceptable forms of identification include: </p>
			<ul>
            ...
            <p>The required documentation may either be delivered to one of the <a href="http://www.flalottery.com/lotteryOffices">Lottery Offices</a> or mailed to:</p>
               <blockquote>
					Florida Lottery<br/>
					   Claims Processing &ndash; CASH4LIFE<sup>&reg;</sup> Bonus Bucks Promotion<br/>
			...
			<p>For additional information about claiming prizes and alternate winners, please read the Official <a href="rules_2018-bonusBucks"> CASH4LIFE<sup>&reg;</sup> Bonus Bucks Second Chance Promotion Rules</a>.</p>
		</div>
	</div>
</div>