	...
	<div id="topBanner">
     ...
     <div id="mainContentWrap">
          <div id="mainContent">
               ...
               <p>To enter your <strong>CASH4LIFE&reg; </strong> voucher number in the Bonus Bucks promotion:</p>
               <div id="sampleTicket">
   ...
   <s:if test="%{promotion.promotionInterval.containsNow()}">
    ...
    <!--Beginning of Promotion Ending Message-->    
     ...
     <!--End of Promotion Ending Message-->               
				<p><span>Florida law prohibits the payment of prizes to persons under the age of 18.
			   ...
			   <hr/>
			     ...
			     <h2 class="tktEntry">My CASH4LIFE Bonus Bucks Voucher Entry List <!--<span><s:property escapeHtml="false" value="%{promotion.name}" /></span> <s:property value="messages.h1Title" />--> </h2>
