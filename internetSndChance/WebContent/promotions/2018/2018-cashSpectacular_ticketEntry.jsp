...
<div id="main" class="cashSpectacular entry">
	<div id="topBanner">
     ...
     <div id="mainContentWrap">
          <div id="mainContent">
               ...
               <p>To enter your non-winning <strong>FLORIDA X THE CASH </strong> Scratch-Off ticket in the second chance promotion:</p>
               <div id="sampleTicket">
                    <img src="promotions/2018/images/jpg/100XTheCash_TicketSample.jpg" alt="Cash Spectacular Ticket Sample" width="365" height="421" align="left" />
               </div>
               <ol>
   ...
   <s:if test="%{promotion.promotionInterval.containsNow()}">
		<s:form id="ticketEntryForm" action="entry_2018-cashSpectacular">	
    ...
    <!--Beginning of Promotion Ending Message-->    
     ...
     <!--End of Promotion Ending Message-->               
			  ...
			  <p>Once you have entered your first ticket, you are ready to enter again. You'll find a record of your entries at the bottom of this page. Enter as many non-winning valid tickets as you wish, but any single ticket may only be entered once into one drawing. <strong>Remember: Do NOT throw away the tickets that you submit online. Winners must have them to claim their prizes.</strong></p>
               ...
               <hr />
               <h2 class="tktEntry">My FLORIDA X THE CASH Ticket Entry List <!--<span><s:property escapeHtml="false" value="%{promotion.name}" /></span> <s:property value="messages.h1Title" />--> </h2>
               ...
               <table class="dataTbl tktEntry" style="width: 100%; ">
                    ...
                    <tbody>
                         ...
                         <tr class="row_2">
                              <td colspan="6" style="text-align: center; padding: 12px; font-weight: bold; font-size:14px; ">No entries submitted.</td>
                         </tr>
                         </s:if>
                         <s:else>
