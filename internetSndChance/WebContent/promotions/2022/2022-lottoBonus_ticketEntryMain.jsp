...
<tiles:insertTemplate template="../../structure/baseTemplate.jsp">
	<tiles:putAttribute name="additionalHeader" type="string" value="<link rel='stylesheet' type='text/css' href='promotions/2022/style/2022-lottoPromo.css' />" />
	...
	<tiles:putAttribute name="body" type="template" value="../promotions/2022/2022-lottoBonus_ticketEntry.jsp" />
