...
<tiles:insertTemplate template="../../structure/baseTemplate.jsp">
	<tiles:putAttribute name="additionalHeader" type="string" value="<link rel='stylesheet' type='text/css' href='promotions/2022/style/2022-jackpotRaffle.css' />" />
	...
	<tiles:putAttribute name="body" type="template" value="../promotions/2022/2022-jackpotRaffle_howtoplay.jsp" />
