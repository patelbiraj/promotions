	...
	<div id="mainContentWrap">
	  <div id="mainContent">
		<h1><s:property value="messages.h1Title" /></h1>
		  <p>If you're a winner in the <strong>MONOPOLY<sup>&trade;</sup> DOUBLER BONUS PLAY PROMOTION</strong>, congratulations!</p>
          <p>The Florida Lottery's Claims Processing Office will attempt to notify the prize winners no later than one business day after the prizewinners are posted on the Florida Lottery's website. 
           If you have not yet been contacted and would like to claim your prize, please call (850) 487-7707.</p>
          			
			<p>To claim a prize won in the Promotion drawing, the prizewinner must submit to the Florida Lottery the following documentation:</p>	
			<p></p>
				
			<ol>
								
				<li>Completed and signed Winner Claim Form: <a href="http://www.floridalottery.com/exptkt/claimForm_en.pdf" target="_blank">English</a> &nbsp; <a href="http://www.floridalottery.com/exptkt/spanishWinnerClaim.pdf" target="_blank">Spanish</a> </li>
		...
		<p><strong>Acceptable forms of identification include: </strong></p>		         		
            ...
            <p>The required documentation may either be delivered to one of the <a href="http://www.floridalottery.com/lotteryOffices">Lottery Offices</a> or mailed to:</p>
               <blockquote>
					Florida Lottery<br/>
					<strong><span style="text-decoration: underline;">MONOPOLY DOUBLER BONUS PLAY PROMOTION<br/>
		  ...
		  <p style="text-decoration: underline;">The required documentation must be received by the Florida Lottery no later than <span style="font-weight: 900px">ten calendar</span> days after being notified by the Florida Lottery that you are a winner.</p>
			...
			<p>For additional information about claiming prizes and alternate winners, please read the Official <a href="rules_2022-monopolyDoubler">MONOPOLY Doubler Bonus Play Promotion Rule </a>.</p>
		</div>
	</div>
</div>