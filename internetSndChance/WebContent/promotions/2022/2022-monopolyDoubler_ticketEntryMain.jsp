...
<%
	response.setHeader("X-Frame-Options", "sameorign");
	response.setHeader("X-Content-Type-Options", "nosniff");
	response.setHeader("Strict-Transport-Security", "max-age=31536000; includeSubDomains; preload");
%>

<tiles:insertTemplate template="../../structure/baseTemplate.jsp">
	<tiles:putAttribute name="additionalHeader" type="string" value="<link rel='stylesheet' type='text/css' href='promotions/2022/style/2022-monopolyDoubler.css' />" />
	...
	<tiles:putAttribute name="body" type="template" value="../promotions/2022/2022-monopolyDoubler_ticketEntry.jsp" />
