...
<s:if
	...
	<s:set var="content"
		value="%{'promotions/2022/2022-lottoPromo-2_winrpt.html'}" />
</s:if>

<script type="text/javascript" src="js/secondChance.js"></script>
<script type="text/javascript">
	var page = 5;
	var baseurl = 'winners_2022-lottoBonusPlay?winrpt=';
	function visit1(){
		var query = "promotions/2022/2022-lottoPromo-1_winrpt.html";
		var url = baseurl + encodeURIComponent(query);
		location.href =  url;
	}
	function visit2(){
		var query = "promotions/2022/2022-lottoPromo-2_winrpt.html";
		var url = baseurl + encodeURIComponent(query);
		location.href =  url;
	}	
			...
			<div id="subNavContent">
				...
				<ul>
					...
					<li>
						...
						<a href="promotions/2022/2022-lottoPromo-1_winrpt.html">
					 ...
					 <li>
						...
						<a href="promotions/2022/2022-lottoPromo-2_winrpt.html">
							<img src="images/png/printer.png" alt="Print Winners" width="34"
								height="19" border="0" title="Print Winners" />
						</a>
					</li>
