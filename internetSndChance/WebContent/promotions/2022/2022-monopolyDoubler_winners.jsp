...
<s:if
	...
	<s:set var="content"
		value="%{'promotions/2022/2022-monopolyDoubler-2_winrpt.html'}" />
</s:if>

<script type="text/javascript" src="js/secondChance.js"></script>
<script type="text/javascript">
	var page = 5;
	var baseurl = 'winners_2022-monopolyDoubler?winrpt=';
	function visit1(){
		var query = "promotions/2022/2022-monopolyDoubler-1_winrpt.html";
		var url = baseurl + encodeURIComponent(query);
		location.href =  url;
	}
	function visit2(){
		var query = "promotions/2022/2022-monopolyDoubler-2_winrpt.html";
		var url = baseurl + encodeURIComponent(query);
		location.href =  url;
	}
...
<div id="main" class="monopolyDoubler">
	<div id="topBanner">
		...
		<div id="subNav">
			<div id="subNavContent">
				...
				<ul>
					...
					<li><a onClick="visit1()" class="toIframe" href="#">July 20, 2022</a> <a href="promotions/2022/2022-monopolyDoubler-1_winrpt.html">
							<img src="images/png/printer.png" alt="Print Winners" width="34"
							height="19" border="0" title="Print Winners" />
					</a></li>
					<li><a onClick="visit2()" class="toIframe" href="#">August 3, 2022</a> <a href="promotions/2022/2022-monopolyDoubler-2_winrpt.html">
							<img src="images/png/printer.png" alt="Print Winners" width="34"
							height="19" border="0" title="Print Winners" />
					</a></li> 
