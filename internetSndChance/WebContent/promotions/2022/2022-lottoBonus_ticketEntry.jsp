...
<meta http-equiv="Content-Security-Policy" content="default-src 'self'; frame-ancestors 'self'; img-src *;">s
...
<div id="main">
	<div id="topBanner">
		<jsp:include
			page="../2022/includes/2022-lottoBonus_navigation.jsp"></jsp:include>
	</div>
	<div id="mainContentWrap">
		<div id="mainContent">
			...
			<h1>TICKET ENTRY</h1>
			<p><strong>To enter your FLORIDA LOTTO<sup>&reg;</sup> ticket purchased between April 11 and May 22, 2022, into the Lotto Bonus Play Promotion:</strong></p>
			<div id="sampleTicket">
				<img src="promotions/2022/images/jpg/2022FLLotto_SecondChanceTicket.jpg"
					alt="Holiday Getaway Tickets" width="331" height="405">
			</div>
			<ol>
			<li>Locate the barcode at the bottom of your FLORIDA LOTTO ticket and scan it using the Florida Lottery mobile app, or manually enter your ticket by typing in the 19-digit number. (See ticket sample). </li>			
			
			<!--  <li>Locate the barcode at the bottom of your FLORIDA LOTTO ticket and scan it using the Florida Lottery mobile app,<br><br> <span style="text-align:center; padding-left:200px; font-weight:bolder;">OR</span>
			<br><br>
				manually enter your ticket by typing in the 19-digit number. (See ticket sample). 
    ...
    <!--Beginning of Promotion Entry Form http://localhost:9080/secondchance/winners_2022-lottoBonusPlay  http://localhost:9080/secondchance/entry_2022-lottoBonusPlay--> 
    			<s:if test="%{promotion.promotionInterval.containsNow()}">
    				<s:form id="ticketEntryForm" action="entry_2022-lottoBonusPlay">
    					<p><s:textfield name="form.ticketNumber" id="ticketNumber" maxlength="19" cssClass="tktNumber" />
 ...
 -->    					<p class="buttonBar"> <s:submit name="form.submitFlag" value="Submit" id="submit" cssClass="ticketSubmit translate" onclick="checkMobileEntry();"/>
    ...
    <!--Beginning of Promotion Ending Message-->    
     ...
     <!--End of Promotion Ending Message-->  
			...
			<p>Once you have entered your first ticket, you are ready to enter again. You'll find a record of your entries at the bottom of this page. A single ticket may only be entered once into one drawing.</p>
			...
			<h2 class="tktEntry" ><span style="width:100%;">My FLORIDA LOTTO Bonus Play Entry List</span>
				<!--<span><s:property escapeHtml="false" value="%{promotion.name}" /></span> <s:property value="messages.h1Title" />-->
			</h2>

			<table class="dataTbl tktEntry" 
				style="width: 100%; margin-top: 40px; margin-left: 0px; align: center;">
				<thead>
					<tr class="row_head">
...
<!-- 		<p class="boldNote">
			...
			<p class="boldNote">
				ENTRIES CAN ONLY BE SUBMITTED BETWEEN THE HOURS OF 6:00 A.M. AND 11:59 P.M., ET. <br> ENTRIES WILL BE LIMITED TO 200 PER PLAYER, PER
				DAY.
			</p>			
