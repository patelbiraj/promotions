...
<s:if
	...
	<s:set var="content"
		value="%{'promotions/2025/2025-forLife_winrpt-1.html'}" />
</s:if>
<script type="text/javascript" src="js/secondChance.js"></script>
<script type="text/javascript">
	var page = 5;
	var baseurl = 'winners_2025-forLife?winrpt=';
	function visit1(){
		var query = "promotions/2025/2025-forLife_winrpt-1.html";
		var url = baseurl + encodeURIComponent(query);
		location.href =  url;
	}
	function visit2(){
		var query = "promotions/2025/2025-forLife_winrpt-2.html";
		var url = baseurl + encodeURIComponent(query);
		location.href =  url;
	}
		...
		<div id="subNav">
			<div id="subNavContent">
				<h3 style="text-align: left;">Select a Drawing</h3>
				 <ul>
					<li>
						<a onClick="visit1()" class="toIframe" href="#">July 22, 2025</a> 
						<a href="promotions/2025/2025-forLife_winrpt-1.html">
							<img src="images/png/printer.png" alt="Print Winners" width="34"
							height="19" border="0" title="Print Winners" />
						</a>
					</li>
					<li>
						<a onClick="visit2()" class="toIframe" href="#">August 12, 2025</a> 
						<a href="promotions/2025/2025-forLife_winrpt-2.html">
							<img src="images/png/printer.png" alt="Print Winners" width="34"
							height="19" border="0" title="Print Winners" />
						</a>
					</li>
