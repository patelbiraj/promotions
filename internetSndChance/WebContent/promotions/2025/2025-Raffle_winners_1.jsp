...
<joda:parseDateTime var="Winners1" value="04/14/2025 14:00:00" pattern="M/d/y H:m:s" />
...
<s:if
	...
	<s:set var="content"
		value="%{'promotions/2024/2024-Raffle-1_winrpt.html'}" />
</s:if>
